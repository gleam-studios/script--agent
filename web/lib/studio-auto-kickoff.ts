...
export const STUDIO_AUTO_STAGE_USER_MESSAGE: Record<1 | 2 | 3 | 4 | 5 | 6 | 7, string> = {
  ...
  5: [
    ...
    "直接输出 STAGE 5「设定集」模板交付物：以 ∆人物/∆物品/∆场景 分类，每个资产以 @名称 注册，",
  ...
  7: [
    "请作为编剧助理，在严格服从【工程注入】与侧栏「系列圣经」的前提下，",
    "基于已定事件链、设定集和分集大纲，直接输出 STAGE 7「分集剧本」模板交付物：",
    "按集、场次、幕拆分，场次头部须用 ∆ 行声明资产（∆场景/∆角色/∆物品）+ 场次目标与结果；",
    "幕的「正文」须为一整段连续叙事（描写+动作+对白融合，禁止拆出「对白要点：」「画面/镜头：」等子标签），",
    "对白直接嵌入叙事：@角色名 [可选动作]：\"台词\"，不同角色断行后继续叙事，",
    "每幕正文须充实饱满，写清细节和情绪，",
    "正文中每次提到任何资产（角色/物品/场景）必须 @名称，与设定集一致；",
    "结构完整；无需我先发言或反问。",
  ].join(""),
};
